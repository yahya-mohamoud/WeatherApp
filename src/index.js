  ...
  async  function fetchData() {
    ...
    try {
      ...
      searchBtn.addEventListener("click", async () => {
        ...
        cityNm.innerText = weatherData.address;
        weatherPlcTwo.appendChild(cityNm)

        const temp = document.createElement("h2")
        temp.classList.add("temp")
        temp.innerText = Math.round((weatherData.currentConditions.temp - 32) * 5 / 9) + "℃";
        ...
        windText.innerText = weatherData.currentConditions.windspeed + "km/hr";
        ...
        desc.id = "desc"
        desc.innerText = weatherData.description;
